...
public class TelaApagarCenario extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					TelaApagarCenario frame = new TelaApagarCenario();
	...
	private void initialize() {
		...
		lblNome = new JLabel("Nome do Cenario");
		...
		btnApagar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				try {
					...
					Fachada.excluirCenario(nome);		
					lblmsg.setText("cenario excluido com sucesso ");
				} catch (Exception e) {
