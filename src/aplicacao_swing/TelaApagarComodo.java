...
public class TelaApagarComodo extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					TelaApagarComodo frame = new TelaApagarComodo();
	...
	private void initialize() {
		...
		lblNome = new JLabel("Nome do Comodo");
		...
		btnApagar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				try {
					...
					Fachada.excluirComodo(nome);		
					lblmsg.setText("comodo excluido com sucesso ");
				} catch (Exception e) {
